...
export default function HadistNiatScreen() {
...
<Text style={styles.headerTitle}>Hadist Tentang Niat</Text>
</View>

<View style={styles.content}>
<View style={styles.card}>
<Text style={styles.arab}>إِنَّمَا الْأَعْمَالُ بِالنِّيَّاتِ</Text>
<Text style={styles.latin}>"Innamal a'maalu bin niyyaat"</Text>
<Text style={styles.arti}>Artinya: "Sesungguhnya segala perbuatan itu bergantung pada niatnya."</Text>
</View>
</View>
</View>
);
