...
export default function HadistKebersihanScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Hadist Kebersihan</Text>
      </View>

      <View style={styles.content}>
        <View style={styles.card}>
          <Text style={styles.arab}>الطُّهُورُ شَطْرُ الإِيمَانِ</Text>
          <Text style={styles.latin}>"Ath-thuhuuru syathrul iimaan."</Text>
          <Text style={styles.arti}>Artinya: "Bersuci (kebersihan) itu adalah sebagian dari iman." {"\n\n"}(HR. Muslim)</Text>
        </View>
      </View>
    </View>
  );
