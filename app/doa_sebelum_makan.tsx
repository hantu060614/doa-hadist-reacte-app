...
export default function DoaSebelumMakanScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Doa Sebelum Makan</Text>
      </View>
      
      <View style={styles.content}>
        <View style={styles.card}>
          <Text style={styles.arab}>اللَّهُمَّ بَارِكْ لَنَا فِيمَا رَزَقْتَنَا وَقِنَا عَذَابَ النَّارِ</Text>
          <Text style={styles.latin}>"Allahumma baarik lanaa fiimaa razaqtanaa wa qinaa 'adzaaban naar."</Text>
          <Text style={styles.arti}>Artinya: "Ya Allah, berkahilah kami dalam rezeki yang telah Engkau berikan kepada kami dan peliharalah kami dari siksa api neraka."</Text>
        </View>
      </View>
    </View>
  );
